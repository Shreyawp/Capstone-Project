...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        fig = px.pie(success_counts, names=success_counts.index.astype(str),  
...
def get_payload_scatter_chart(entered_site, entered_payload):
    ...
    if entered_site == 'ALL':
        fig = px.scatter(filtered_df, x='Payload Mass (kg)', y='class', 
                         ...
                         title="Payload Mass vs Success rate of All Launch Sites")
        return fig
    else:
        filtered_df = spacex_df[spacex_df['Launch Site'] == entered_site]
        fig = px.scatter(filtered_df, x='Payload Mass (kg)', y='class', 
                         color="Booster Version Category", 
                         title=f"Payload Mass vs Success rate of {entered_site}")
        return fig
